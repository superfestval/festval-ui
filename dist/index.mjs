...
var Root = ({ children }) => {
  return /* @__PURE__ */ jsx2("div", { className: "flex flex-col rounded bg-zinc-100", children });
};

// src/components/ui/card/header.tsx
import { tv as tv2 } from "tailwind-variants";
import { jsx as jsx3, jsxs } from "react/jsx-runtime";
var headerVariant = tv2({});
var iconVariant = tv2({
...
var Header = ({ children, iconColor, icon: Icon }) => {
  return /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between rounded-t bg-zinc-200 p-4", children: [
    children,
    Icon && /* @__PURE__ */ jsx3("div", { className: iconVariant({ variant: iconColor }), children: /* @__PURE__ */ jsx3(Icon, { size: 16 }) })
  ] });
};
...
var CardText = (_a) => {
  ...
  return /* @__PURE__ */ jsx4("p", __spreadProps(__spreadValues({ className: "text-md text-zinc-400" }, rest), { children }));
};

// src/components/ui/card/footer.tsx
import { tv as tv3 } from "tailwind-variants";
import { jsx as jsx5 } from "react/jsx-runtime";
var cardfooterVariant = tv3({
...
var CardFooter = (_a) => {
  ...
  return /* @__PURE__ */ jsx5("div", __spreadProps(__spreadValues({ className: cardfooterVariant({ className }) }, rest), { children }));
};

// src/components/ui/card/heading.tsx
import { jsx as jsx6 } from "react/jsx-runtime";
var CardHeading = ({ children }) => {
  return /* @__PURE__ */ jsx6("h3", { className: "text-xl font-bold text-zinc-500", children });
};
...
var Table = {
  Root: (_a) => {
    var _b = _a, { children } = _b, rest = __objRest(_b, ["children"]);
    return /* @__PURE__ */ jsx7("table", __spreadProps(__spreadValues({ className: "m-auto mt-6 w-full max-w-[1120px]" }, rest), { children }));
  },
  Caption: (_c) => {
  ...
  THead: (_e) => {
    ...
    return /* @__PURE__ */ jsx7("thead", __spreadProps(__spreadValues({ className: "rounded-t" }, rest), { children }));
  },
  TBody: (_g) => {
    var _h = _g, { children } = _h, rest = __objRest(_h, ["children"]);
    return /* @__PURE__ */ jsx7("tbody", __spreadProps(__spreadValues({}, rest), { children }));
  },
  Tr: (_i) => {
    var _j = _i, { children } = _j, rest = __objRest(_j, ["children"]);
    return /* @__PURE__ */ jsx7("tr", __spreadProps(__spreadValues({ className: "rounded-t bg-zinc-50" }, rest), { children }));
  },
  Th: (_k) => {
    ...
    return /* @__PURE__ */ jsxs2("th", __spreadProps(__spreadValues({}, rest), { className: cellHeadVariant({ position }), children: [
      children,
      onClick && /* @__PURE__ */ jsx7("button", { onClick, className: "ml-4", children: /* @__PURE__ */ jsx7(ArrowDownUp, { size: 12 }) })
    ] }));
  },
  Td: (_m) => {
    var _n = _m, { children } = _n, rest = __objRest(_n, ["children"]);
    return /* @__PURE__ */ jsx7("td", __spreadProps(__spreadValues({ className: "border-b border-b-zinc-200 px-4 py-2" }, rest), { children }));
  }
};
...
function Avatar({ image, username }) {
  return /* @__PURE__ */ jsx8("div", { className: "h-14 w-14 rounded-full border-[3px] border-yellow-700 p-1", children: /* @__PURE__ */ jsx8(
    "img",
    {
      src: image,
      alt: username,
...
var overlayVariant = tv5({
  base: "fixed inset-0 bg-blackA6 data-[state=open]:animate-overlayShow bg-zinc-950/25 backdrop-blur"
});
var containerVariant = tv5({
  base: "max-w-[500px] fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 rounded-md bg-white focus:outline-none"
});
var contentVariant = tv5({
  base: "p-4"
});
var footerVariant = tv5({
  base: "flex gap-4 p-4 border-t border-t-zinc-200"
});
var headerVariant2 = tv5({
  base: "p-4"
});
var Dialog = {
  Root: (_a) => {
    var _b = _a, { children } = _b, rest = __objRest(_b, ["children"]);
    return /* @__PURE__ */ jsx9(DialogPrimitive.Root, __spreadProps(__spreadValues({}, rest), { children }));
  },
  Portal: (_c) => {
    var _d = _c, { children } = _d, rest = __objRest(_d, ["children"]);
    return /* @__PURE__ */ jsx9(DialogPrimitive.Portal, __spreadProps(__spreadValues({}, rest), { children }));
  },
  Trigger: (_e) => {
    var _f = _e, { children } = _f, rest = __objRest(_f, ["children"]);
    return /* @__PURE__ */ jsx9(DialogPrimitive.Trigger, __spreadProps(__spreadValues({}, rest), { children }));
  },
  Overlay: (_g) => {
  ...
  Header: ({ children, className }) => /* @__PURE__ */ jsxs3("div", { className: headerVariant2({ className }), children: [
    /* @__PURE__ */ jsx9(DialogPrimitive.Close, { asChild: true, children: /* @__PURE__ */ jsx9(
      "button",
      {
  ...
  Content: ({ children, as = "form", className }) => {
    const As = as;
    return /* @__PURE__ */ jsx9(As, { className: contentVariant({ className }), children });
  },
  Container: (_i) => {
  ...
  Description: (_m) => {
    var _n = _m, { children } = _n, rest = __objRest(_n, ["children"]);
    return /* @__PURE__ */ jsx9(DialogPrimitive.Description, __spreadProps(__spreadValues({ className: "text-zinc-400" }, rest), { children }));
  },
  Close: (_o) => {
    var _p = _o, { children } = _p, rest = __objRest(_p, ["children"]);
    return /* @__PURE__ */ jsx9(DialogPrimitive.Close, __spreadProps(__spreadValues({}, rest), { children }));
  },
  Footer: (_q) => {
    var _r = _q, { children, className } = _r, rest = __objRest(_r, ["children", "className"]);
    return /* @__PURE__ */ jsx9("div", __spreadProps(__spreadValues({}, rest), { className: footerVariant({ className }), children }));
  }
};
...
function Action2(_a) {
  var _b = _a, { children } = _b, rest = __objRest(_b, ["children"]);
  return /* @__PURE__ */ jsx10(AlertDialogPrimitive.Action, __spreadProps(__spreadValues({}, rest), { children }));
}
...
function Cancel2(_a) {
  var _b = _a, { children } = _b, rest = __objRest(_b, ["children"]);
  return /* @__PURE__ */ jsx11(AlertDialogPrimitive2.Cancel, __spreadProps(__spreadValues({}, rest), { children }));
}
...
function Description3(_a) {
  ...
  return /* @__PURE__ */ jsx13(AlertDialogPrimitive4.Description, __spreadProps(__spreadValues({}, rest), { className: "text-zinc-500", children }));
}
...
function Portal3(_a) {
  var _b = _a, { children } = _b, rest = __objRest(_b, ["children"]);
  return /* @__PURE__ */ jsx15(AlertDialogPrimitive6.Portal, __spreadProps(__spreadValues({}, rest), { children }));
}
...
function Root4(_a) {
  var _b = _a, { children } = _b, rest = __objRest(_b, ["children"]);
  return /* @__PURE__ */ jsx16(AlertDialogPrimitive7.Root, __spreadProps(__spreadValues({}, rest), { children }));
}
...
function Trigger3(_a) {
  var _b = _a, { children } = _b, rest = __objRest(_b, ["children"]);
  return /* @__PURE__ */ jsx18(AlertDialogPrimitive9.Trigger, __spreadProps(__spreadValues({}, rest), { children }));
}
...
var Input = forwardRef(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ jsxs4(Fragment, { children: [
      /* @__PURE__ */ jsx19("div", { className: variants({ className, hasError: !!error }), children: mask ? /* @__PURE__ */ jsx19(
        InputMask,
        __spreadProps(__spreadValues({}, rest), {
          mask,
          replacement: {
      ...
      error && /* @__PURE__ */ jsx19("p", { className: "mt-1 text-xs text-rose-600", children: error })
    ] });
  }
);
...
var labelVariant = tv7({
  base: "font-bold text-zinc-600"
});
function Label(_a) {
  var _b = _a, { children, className } = _b, rest = __objRest(_b, ["children", "className"]);
  return /* @__PURE__ */ jsx20("label", __spreadProps(__spreadValues({}, rest), { className: labelVariant({ className }), children }));
}
...
var SelectProvider = ({ children, onChange }) => {
  ...
  return /* @__PURE__ */ jsx21(SelectContext.Provider, { value, children });
};
var useSelect = () => useContext(SelectContext);

// src/components/ui/form/select/components/content.tsx
import { jsx as jsx22 } from "react/jsx-runtime";
var contentVariable = tv8({
...
var Content4 = ({ children }) => {
  ...
  return /* @__PURE__ */ jsx22("div", { className: contentVariable({ isOpen }), children });
};
...
var Root5 = ({ children, onValeuChange }) => {
  return /* @__PURE__ */ jsx24(SelectProvider, { onChange: onValeuChange, children: /* @__PURE__ */ jsx24("div", { className: "relative", children }) });
};
...
var Trigger4 = ({ placeholder }) => {
  ...
  return /* @__PURE__ */ jsxs5("button", { onClick: onTriggerClick, className: triggerVariable({ isOpen }), children: [
    ...
    isOpen ? /* @__PURE__ */ jsx25(ChevronUpIcon, {}) : /* @__PURE__ */ jsx25(ChevronDownIcon, {})
  ] });
};
...
function Button(_a) {
  ...
  return /* @__PURE__ */ jsxs6(As, __spreadProps(__spreadValues({}, rest), { className: buttonVariant({ className, variant: variant2, disabled }), children: [
    IconLeft && /* @__PURE__ */ jsx26(IconLeft, {}),
    children,
    IconRight && /* @__PURE__ */ jsx26(IconRight, {})
  ] }));
}
...
function Checkbox({
  ...
  return /* @__PURE__ */ jsx27(
    "button",
    {
      ...
      children: isChecked && /* @__PURE__ */ jsx27(Check, { size: 18 })
    }
  );
}
...
import { Fragment as Fragment2, jsx as jsx28, jsxs as jsxs7 } from "react/jsx-runtime";
var variants3 = tv12({
...
var TextArea = forwardRef2(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ jsxs7(Fragment2, { children: [
      /* @__PURE__ */ jsx28("div", { className: variants3({ className }), children: /* @__PURE__ */ jsx28(
        "textarea",
        __spreadProps(__spreadValues({
          ref
        }, rest), {
      ...
      error && /* @__PURE__ */ jsx28("p", { className: "mt-1 text-xs text-red-600", children: error })
    ] });
  }
);
    ...
    return /* @__PURE__ */ jsxs8("div", { className: "flex w-full items-center justify-center rounded border border-dashed border-zinc-200 bg-zinc-100 text-zinc-950", children: [
      /* @__PURE__ */ jsx29(
        "label",
        {
          ...
          children: /* @__PURE__ */ jsx29("div", { className: "flex w-full items-center justify-center", children: /* @__PURE__ */ jsx29("small", { children: !files ? /* @__PURE__ */ jsxs8("div", { className: "p-4", children: [
            /* @__PURE__ */ jsx29("p", { children: "Clique aqui para inserir um documento" }),
            /* @__PURE__ */ jsx29("div", { className: "flex items-center justify-center p-4", children: /* @__PURE__ */ jsx29(UploadIcon, { className: "text-zinc-400" }) }),
            ...
            /* @__PURE__ */ jsx29("p", { children: "Arquivos selecionados:" }),
            /* @__PURE__ */ jsx29("div", { className: "mt-4", children: Array.from(files).map((item, index) => /* @__PURE__ */ jsxs8("small", { children: [
              item.name,
              " ",
              index > 0 && ", "
            ] }, item.name)) }),
            /* @__PURE__ */ jsx29("small", { className: "text-zinc-500" })
          ] }) }) })
        }
      ),
      /* @__PURE__ */ jsx29(
...
function Menu({ signOut, children, username, avatarImage }) {
  return /* @__PURE__ */ jsx30(Navigation.Root, { id: "navigation", children: /* @__PURE__ */ jsx30(Navigation.List, { children: /* @__PURE__ */ jsxs9(Navigation.Item, { children: [
    /* @__PURE__ */ jsx30(Navigation.Trigger, { children }),
    /* @__PURE__ */ jsxs9(Navigation.Content, { className: "absolute right-2 w-[300px] rounded bg-zinc-50 shadow", children: [
      /* @__PURE__ */ jsxs9("div", { className: "flex w-full items-center gap-4 border-b border-b-zinc-200 p-2", children: [
        /* @__PURE__ */ jsx30(Avatar, { image: avatarImage, username }),
        /* @__PURE__ */ jsx30("p", { className: "inline-block", children: username })
      ] }),
      /* @__PURE__ */ jsx30("div", { className: "w-full p-4", children: /* @__PURE__ */ jsx30(Button, { onClick: signOut, className: "w-full", children: "Sair" }) })
    ] })
  ] }) }) });
}
...
var imageVariation = tv13({
  base: "w-24"
});
function Image(_a) {
  var _b = _a, { className } = _b, rest = __objRest(_b, ["className"]);
  return /* @__PURE__ */ jsx31("img", __spreadValues({ className: imageVariation({ className }) }, rest));
}

// src/components/surfaces/header/root.tsx
import { tv as tv14 } from "tailwind-variants";
import { jsx as jsx32 } from "react/jsx-runtime";
var rootVariation = tv14({
  base: "fixed left-0 top-0 w-full bg-zinc-950"
});
function Root7(_a) {
  var _b = _a, { children, className } = _b, rest = __objRest(_b, ["children", "className"]);
  return /* @__PURE__ */ jsx32("header", __spreadProps(__spreadValues({ className: rootVariation({ className }) }, rest), { children: /* @__PURE__ */ jsx32("div", { className: "m-auto flex w-full max-w-4xl items-center justify-between p-4", children }) }));
}
...
function Text(_a) {
  ...
  const As = as;
  return /* @__PURE__ */ jsx33(As, __spreadProps(__spreadValues({ className: textVariant({ size }) }, rest), { children }));
}

// src/components/typograph/heading/index.tsx
import { tv as tv16 } from "tailwind-variants";
import { jsx as jsx34 } from "react/jsx-runtime";
var headingVariant = tv16({
  variants: {
    size: {
...
function Heading(_a) {
  ...
  const As = as;
  return /* @__PURE__ */ jsx34(As, __spreadProps(__spreadValues({ className: headingVariant({ size, className }) }, rest), { children }));
}
export {
  AlertDialog,
  Avatar,
