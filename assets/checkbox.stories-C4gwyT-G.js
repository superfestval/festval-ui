        ...
        <tbody>
          ...
          length: 5
              ...
              <td className="border-b border-b-gray-600 p-2">
                <Checkbox defaultChecked={keys.includes(index)} onValueChange={() => select(index)} />
              </td>
              <td className="border-b border-b-gray-600 p-2">
                <p>Example {index}</p>
              </td>
